...
这个区块用于在 GitHub 仓库主页直接查看最新参考比分。以下结果已纳入已完赛比分、赛前情报和模型默认的足球单场随机性。预测结果仅供参考，请理性观赛。

| 比赛 | 概率最大结果 | 主要概率 | 预测原因摘要 |
| --- | --- | --- | --- |
| 荷兰 vs 瑞典 | 荷兰略占优，预测比分 1-0 | 荷兰胜 55.4% / 平 23.5% / 瑞典胜 21.1% | 荷兰基础评级更高，预期进球约 1.77-0.87；瑞典首战大胜只做小幅修正，仍保留平局和冷门路径。 |
| 德国 vs 科特迪瓦 | 德国略占优，预测比分 2-0 | 德国胜 66.9% / 平 19.8% / 科特迪瓦胜 13.3% | 德国评级和机会质量优势明显，预期进球约 2.04-0.56；科特迪瓦的低位防守和反击可能压低比分。 |
| 厄瓜多尔 vs 库拉索 | 厄瓜多尔略占优，预测比分 2-0 | 厄瓜多尔胜 68.9% / 平 19.1% / 库拉索胜 12.1% | 厄瓜多尔基础评级领先，库拉索首战防守样本偏弱；早段进球或红牌仍可能显著改变节奏。 |
| 突尼斯 vs 日本 | 日本略占优，预测比分 0-1 | 突尼斯胜 20.5% / 平 23.5% / 日本胜 56.0% | 日本评级和转换进攻表现占优，预期进球约 0.84-1.77；突尼斯收缩阵型时有机会把比赛拖入低比分。 |
